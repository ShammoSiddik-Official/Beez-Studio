...
export const DESIGN_SYSTEM = {
  title: 'BeeZ Studio Design System',
  description:
    'A calm architectural visual language for BeeZ Studio’s public website and studio console.',
} as const;
    ...
    entries: [
      {
        ...
        description: 'The BeeZ Studio mark, imagery direction, and visual language.',
        Page: BrandPage,
      },
    ],
  },
    ...
    entries: [
      {
        ...
        name: 'Voice and composition',
        description: 'Clear, precise, human content guidance for studio surfaces.',
        Page: ContentPage,
      },
    ],
  },
    ...
    entries: [
      {
        ...
        description: 'Measured transitions that reveal hierarchy without distraction.',
        Page: MotionPage,
      },
    ],
  },
