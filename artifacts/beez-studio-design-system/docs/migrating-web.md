# Migrating web UI to BeeZ Studio Design System

Read `artifacts/beez-studio-design-system/docs/AGENTS.md` and
`artifacts/beez-studio-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/beez-studio-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/beez-studio-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/beez-studio-design-system/hooks/use-toast`
