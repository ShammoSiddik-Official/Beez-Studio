# Consuming BeeZ Studio Design System in Expo apps

Read `artifacts/beez-studio-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/beez-studio-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/beez-studio-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/beez-studio-design-system/lib/native-theme";
import { useColors } from "@workspace/beez-studio-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/beez-studio-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/beez-studio-design-system/components/native/badge";
import { Button } from "@workspace/beez-studio-design-system/components/native/button";
import { Card } from "@workspace/beez-studio-design-system/components/native/card";
```
...
Import and render
`@workspace/beez-studio-design-system/components/native/button`, then run Expo
