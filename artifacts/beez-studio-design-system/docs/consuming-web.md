# Consuming BeeZ Studio Design System in web apps

Read `artifacts/beez-studio-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/beez-studio-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/beez-studio-design-system/styles.css";
```
...
`node_modules/@workspace/beez-studio-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/beez-studio-design-system/components/ui/button";
import { cn } from "@workspace/beez-studio-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/beez-studio-design-system/hooks/use-toast";
```
...
`@workspace/beez-studio-design-system/components/ui/button`. Run the app's typecheck
