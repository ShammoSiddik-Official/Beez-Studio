# Migrating Expo UI to BeeZ Studio Design System

Read `artifacts/beez-studio-design-system/docs/AGENTS.md` and
`artifacts/beez-studio-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/beez-studio-design-system/lib/native-theme` and
  `@workspace/beez-studio-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/beez-studio-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/beez-studio-design-system` and retains only
